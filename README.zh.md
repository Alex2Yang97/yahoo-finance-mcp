...
| 工具 | 描述 |
|------|-------------|
| `get_fxmacrodata_catalogue` | 获取某个货币支持的 FXMacroData 宏观指标和端点覆盖范围 |
| `get_fxmacrodata_calendar` | 获取某个货币的宏观经济发布时间表 |
| `get_fxmacrodata_latest_announcements` | 获取某个货币的最新宏观经济公告 |
...
- `FXMD_API_KEY` 可启用受保护的 FXMacroData 货币和端点系列。公开的
  USD 示例无需 API key。
